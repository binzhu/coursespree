<?php /* Smarty version 2.6.26, created on 2012-06-20 00:12:29
         compiled from /home/content/87/9232987/html/xoops/themes/default/theme.html */ ?>
...
" />
    ...
    <!-- Rss -->
    <link rel="alternate" type="application/rss+xml" title="" href="<?php echo 'http://coursespree.com/xoops/backend.php'; ?>" />

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/ico" href="<?php 
echo 'http://coursespree.com/xoops/themes/default/icons/favicon.ico'; ?>" />
    <link rel="icon" type="image/png" href="<?php 
echo 'http://coursespree.com/xoops/themes/default/icons/favicon.png'; ?>" />

    <!-- Sheet Css -->
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php echo 'http://coursespree.com/xoops/xoops.css'; ?>" />
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php 
echo 'http://coursespree.com/xoops/themes/default/style.css'; ?>" />
	<!--[if lte IE 8]>
		<link rel="stylesheet" href="<?php 
echo 'http://coursespree.com/xoops/themes/default/styleIE8.css'; ?>" type="text/css" />
	<![endif]-->
...
<table cellspacing="0">
    <tr id="header">
        <td id="headerlogo"><a href="<?php echo 'http://coursespree.com/xoops/'; ?>" title="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
"><img src="<?php 
echo 'http://coursespree.com/xoops/themes/default/xoops-logo.png'; ?>" alt="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
" /></a></td>
