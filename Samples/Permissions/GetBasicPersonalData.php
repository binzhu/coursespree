...
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head >
		<title>GetBasicPersonalData</title>
...
$returnURL=$url."/../Common/WebflowReturnPage.php";
				...
				<form name="Form1" id="Form1" method="post" action="GetBasicPersonalDataReceipt.php">
					<center>
						<h3>Permissions - GetBasicPersonalData</h3>
						<table>
<tr><td class="smalltext" width="52">Basic Attributes:</td>
<td align="left">
