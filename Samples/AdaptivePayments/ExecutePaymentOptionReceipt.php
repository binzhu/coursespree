...
/********************************************
 ExecutePaymentOptionReceipt.php
...
try {
            ...
            $request_array = array (
			ExecutePayment::$payKey=> $_REQUEST["payKey"],
			...
			$resArray=hash_call("AdaptivePayments/ExecutePayment",$nvpStr);
...
<html>
<head>
  <title>PayPal PHP SDK - ExecutePaymentOption</title>
...
<div id="request_form">
    ...
    <center><h3> ExecutePaymentOption Details</h3></center>
    <br />
