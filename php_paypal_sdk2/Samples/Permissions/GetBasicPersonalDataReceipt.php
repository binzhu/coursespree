...
/********************************************
GetBasicPersonalDataReceipt.php


Called by GetBasicPersonalData.php
********************************************/
...
session_start();
		...
		try {
			...
			$cancelURL = $url. "/GetBasicPersonalData.php" ;
			$request_array= array(
			...
			if(isset($_POST['attr']))
			{
				...
				foreach ($_POST['attr'] as $value)
				{
					...
					$request_array[GetBasicPersonalData::$attributeList[$i]] = $value;
					$i++;
	...
	$resArray=hash_call('Permissions/GetBasicPersonalData',$nvpStr);
...
<center><h3>GetBasicPersonalData - Response</h3>
</center>
<br/>
<?php 
require_once '../Common/menu.html';?>
