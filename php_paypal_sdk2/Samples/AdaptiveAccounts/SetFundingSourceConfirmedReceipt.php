...
session_start();
	...
	/* Make the call to PayPal to set the funding source as confirmed. If an error occured, show the
	 resulting errors
	 Note: if the confirmation type is none then no need of redirecting
	 */

	$resArray=hash_call('AdaptiveAccounts/SetFundingSourceConfirmed',$nvpStr);
...
throw new Exception('Error occurred in SetFundingSourceConfirmedReceipt method');
}
