<?php /* Smarty version 2.6.26, created on 2012-05-15 11:53:29
         compiled from administratorpage.tpl */ ?>
...
"/>
     <?php else: ?>
         <?php if ($_GET['message'] && $_GET['message_type']): ?>
             <frame name = "mainframe" src ="administrator.php?message=<?php echo $_GET['message']; ?>
&message_type=<?php echo $_GET['message_type']; ?>
"/>
         <?php else: ?>
             <frame name = "mainframe" src ="administrator.php"/>
         <?php endif; ?>
     <?php endif; ?>
 </frameset>
<?php else: ?>
