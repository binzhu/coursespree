...
define("_WORKBOOK_EDIT_ANSWERS", "Επεξεργασία απαντήσεων");
define("_WORKBOOK_RESET_MESSAGE_1", "Κανείς μαθητής δεν έχει απαντήσει κάποια ερώτηση. Μπορείτε να επαναφέρετε ασφαλώς το Workbook. Είστε σίγουρος;");
define("_WORKBOOK_RESET_MESSAGE_2", "Ένας μαθητής έχει ήδη απαντήσει κάποιες ερωτήσεις. Η διαδικασία επαναφοράς θα έχει ως αποτέλεσμα την οριστική διαγραφή των απαντήσεων του συγκεκριμένου μαθητή. Είστε σίγουρος;");
define("_WORKBOOK_RESET_MESSAGE_3", "μαθητές έχουν ήδη απαντήσει κάποιες ερωτήσεις. Η διαδικασία επαναφοράς θα έχει ως αποτέλεσμα την οριστική διαγραφή των απαντήσεων των συγκεκριμένων μαθητών. Είστε σίγουρος;");
?>
