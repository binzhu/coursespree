...
<table class="sortedTable" style="width:100%">
	<tr>
		<td class="topTitle">{$smarty.const._GRADEBOOK_RANGE_FROM}</td>
		<td class="topTitle">{$smarty.const._GRADEBOOK_RANGE_TO}</td>
		<td class="topTitle">{$smarty.const._GRADEBOOK_GRADE}</td>
